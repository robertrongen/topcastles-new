<table width=550 border="0" cellpadding="0" cellspacing="0" id="AutoNumber1">
	...
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC))
	{
		...
		{
		$Score = $line ['score_visitors_2005'] / 100 + 5;
		?>
		...
		<tr bgcolor = "<?php
				...
				<?php
					...
					{ ?>
						...
						<div class="thumbnails">
							...
							<Img width="55" SRC=<?php echo "images/small/".$line['castle_code']."_small.jpg" ?>></a>
						</div>
						</td>
					<?php }
					else
				...
				<a href="javascript:document.form81.SelCastle.value='<?php echo $line['castle_code'] ?>';document.form81.submit();"
				title="<?php echo $line['position'].". ".$line['castle_name']." - ".$line['place'] ?>"><?php echo $line['castle_name'] ?></a>&nbsp;&nbsp;
				</td>
				<td height=20 border=0 align="left">
