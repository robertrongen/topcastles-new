	<div class="feature">
		<table>
			<tr>
				<td>
                    <h2><a href="index.php"><?php echo "Poll ".$EnqueteContent; ?></a></h2>
                </td>
			</tr>
			<tr> 
				<td>
					Question: <br><strong><?php echo GetEnquetevragen($EnqueteContent,'en_vraag') ?></strong> 
                </td>
			</tr>
			<tr> 
				<td>
			...
			<tr> 
				<td>
					Start poll: <?php echo GetEnquetevragen($EnqueteContent,'en_startdatum') ?>
			</td>
			</tr>
			<tr>
				<td>
					<h3>Result</h3>
					Votes: <?php echo $total ?>
					<br><br> 
				</td>
			</tr>
			<tr>
				...
				<table>
                    ...
                    <tr bgcolor = "<?php
                            ...
                            ?>"> 
						<td> 
							<?php echo $Teller2.". ".GetEnquetevragen($EnqueteContent,'en_keuze'.$Teller2) ?>
			...
			<tr>
				<td>
					<?php
                    $Toelichting = GetEnquetevragen($EnqueteContent,'en_comment');
