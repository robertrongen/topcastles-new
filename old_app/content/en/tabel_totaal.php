<table width=550 border="0" cellpadding="0" cellspacing="0" id="AutoNumber1">
	...
	while ($line = mysql_fetch_array($result, MYSQL_ASSOC))
	{
		...
		{
		$Score = $line ['score_visitors'] / 100 + 5;
		?>
		...
		<tr bgcolor = "<?php
				...
				<td height=20 border=0 align="left">
				<a href="javascript:document.form42.SubMenu.value='main';document.form42.SelCountry.value='<?php echo $line['country'] ?>';document.form42.submit();" >
				<?php echo $line['country'] ?></a>
				</td>
				<td height=20 border=0 align="right">
				<?php echo $line['position_ref'] ?>&nbsp;&nbsp;
				</td>
				<td height=20 border=0 align="right">
				<?php echo $line['score_ref'] ?>&nbsp;&nbsp;
				</td>
				<td height=20 border=0 align="right">
				<?php echo $Score ?>&nbsp;&nbsp;
				</td>
