		...
		if (($Teller >= $TellerVan) && ($Teller <= $TellerEind))
		{
			...
			?>
				<tr bgcolor = "<?php
						...
						?>"> 
					<td align="right">
						<?php echo $line['position_2007'] ?>&nbsp;&nbsp;
					</td>
					<td align="right">
						<?php echo $line['score_total_2007'] ?>&nbsp;&nbsp;
					</td>
					<?php
						...
						{ 	
							?>
								...
								<div class="thumbnails">
									...
									title="<?php echo $line['position_2007'].". ".$line['castle_name']." - ".$line['land'] ?>">
					...
					?><td width="55">
						<a href="javascript:document.form81.SelCastle.value='<?php echo $line['castle_code'] ?>';document.form81.submit();"
						title="<?php echo $line['position_2007'].". ".$line['castle_name']." - ".$line['place'] ?>">
						<?php
