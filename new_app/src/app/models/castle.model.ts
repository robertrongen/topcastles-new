export interface Castle {
  ...
  // Pre-built search text (generated by generate_lean_castles.js, present in lean file)
  search_text?: string;
...
export interface CountryGazetteerRow {
  ...
  visitorRank: number;
  disagreement: number;
  meanEditorialScore: number;
  meanVisitorScore: number;
  editorialNote?: string;
  definingTradition?: string;
  editorSleeper: boolean;
  topCastleCode: string;
  topCastleName: string;
}
